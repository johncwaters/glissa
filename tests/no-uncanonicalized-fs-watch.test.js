...
// Every fs.watch path must pass canonicalizePath (shared/paths.js): a Windows 8.3 short path aborts node in native code, and the 0.21.0 fix regressed once nothing enforced the seam.
