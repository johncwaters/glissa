...
// A4: listTeams() over the real repo teams dir lists the real teams (marketing, release-notes) and skips
// _shared (no team.json). Membership form (not an exact-array pin) so adding a future team does not
