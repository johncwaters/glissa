...
| `context/conventions.md` | Engineering conventions reference |
| `context/security.md` | Security guidance reference |
| `context/glossary.md` | Project glossary |
| `context/review-checklist.md` | Review checklist reference |
