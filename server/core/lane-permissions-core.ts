 ...
 *     `enableAllProjectMcpServers`, which detection/settings-injector.ts plumbs into the same session's
 ...
 * tests/lane-permissions-core.test.ts rather than left to be rediscovered.
 */
