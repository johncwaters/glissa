/*
 * Pure core of the PostHog monitoring lane (sibling of core/pr-review-core.ts). No IO, no imports:
 ...
 * the way a spawn argument is (session/core/anti-slop-prompt.ts).
 */
