...
const THEMES = {
  ...
  unicorn: {
    ...
    colors: {
      ...
      '--state-running':      '#86e0ab',
      '--state-running-bg':   'rgba(134, 224, 171, 0.10)',
      '--state-waiting':      '#f0c674',
      '--state-waiting-bg':   'rgba(240, 198, 116, 0.10)',
      '--state-failed':       '#e8887e',
      '--state-failed-bg':    'rgba(232, 136, 126, 0.10)',
      '--state-done':         '#eeb0cc',
      '--state-done-bg':      'rgba(238, 176, 204, 0.08)',
      '--state-initializing': '#a89bc0',
      '--state-initializing-bg': 'rgba(168, 155, 192, 0.08)',
      '--state-idle':         '#d4b872',
      '--state-idle-bg':      'rgba(212, 184, 114, 0.08)',
      '--state-starting':     '#b89ce8',
      '--state-starting-bg':  'rgba(184, 156, 232, 0.08)',
      '--state-complete':     '#dd8ecf',
      '--state-complete-bg':  'rgba(221, 142, 207, 0.08)',
    },
    terminal: {
      background:   '#201730',
      foreground:   '#d4c8e6',
