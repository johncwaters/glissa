...
export function bytesForBackwardDeletion(inputType) {
...
export function isTypedInputType(inputType) {
...
export function isImeProcessingKeydown(event) {
  if (!event) return false;
  return event.keyCode === 229 || event.key === 'Process';
}

export function bytesForSoftKeyboardEdit(previousText, nextText) {
