...
export function scrollLinesForDrag(pendingPx, cellHeightPx, maxRowsPerStep = Number.POSITIVE_INFINITY) {
...
export function pushVelocitySample(samples, positionPx, timestampMs) {
...
export function stepInertia(state, nowMs) {
