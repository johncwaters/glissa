...
import { aggregateEl, consumeLocalReorderPending, container, minimizedBar, sessionUIs } from './session-card/card-registry.js';
...
// handleDebugStateResponse + handleDebugStateRefresh moved to
// ./session-card/card-dom.js; re-exported here for app.js until the Phase 4 repoint.
export { handleDebugStateRefresh, handleDebugStateResponse } from './session-card/card-dom.js';

// exitMaximizeMode, isMaximizeActive, setLayoutMode moved to ./session-card/layout.js;
// re-exported here for app.js until the Phase 4 repoint.
