...
| `plan-visions-3.md` | Plan for Visions long-term memory: agent-agnostic machine-global store (JSONL canon + distilled markdown projection + optional node:sqlite FTS5 cache), multi-vendor transcript ingestion, distill lane, pack delivery, milestones M12-M17, nothing shipped |
