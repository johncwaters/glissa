...
| `distribution.md` | How Glimmervoid ships: GitHub repo as source of truth, dotfiles-repo provisioning for servers, `npm i -g github:johncwaters/glimmervoid` for a standalone CLI, no registry publishing |
...
| `plan-agent-adapters.md` | Plan for harness-agnostic Glimmervoid: full CC coupling inventory, live-probed Codex 0.146.0 / Grok 0.2.111 hook and OSC surfaces, AgentAdapter seam design, hook-relay transport, capability gating, milestones M1-M6 |
