...
Status: drafted 2026-08-21 from a full coupling sweep plus live probes of Codex CLI 0.146.0 and Grok CLI 0.2.111 on this machine. M1 is shipped; M2 onward are not. `AGENTS.md` and the code win over this doc, and superseded sections move to `docs/archive/` per convention.
