...
Status: drafted 2026-08-20; M1 to M4 shipped, M5 (intent model) outstanding. `AGENTS.md` and the code win over this doc, and superseded sections move to `docs/archive/` per convention.
