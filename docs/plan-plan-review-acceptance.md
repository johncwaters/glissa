...
Scenarios 1 to 5 each cost one sonnet plan turn plus, for 3, one revision; 6 costs a partial turn. The whole run is around ten minutes and well under a dollar at list price.
