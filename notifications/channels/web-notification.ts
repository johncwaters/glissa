...
// A type alias, not an interface: only an alias gets the implicit index signature that lets it pass
// as the backend's Record<string, unknown> broadcast payload.
