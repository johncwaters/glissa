...
public/
  ...
  session-card/    # Session card modules (decomposed from session-card.js)
    ...
    touch-scroll-core.mjs  # Pure: isScrollGesture, scrollLinesForDrag (row quantization + carried remainder + flick cap), cellHeightFromElement
