...
- **IDLE** - quiescent, PTY alive. The initial state a freshly spawned session lands in (`first_output`), and the post-dismiss quiescent state. Wakes to RUNNING via `working`/`resume`
